...
import com.wy.mydemo.service.SysRoleService;
...
public class SysRoleController extends BaseController {
    private String prefix = "views/system/role";
    ...
    public AjaxResult export(SysRole role) {
        ...
        AjaxResult  ajaxResult = util.exportExcel( list, "角色数据" );
        return ajaxResult;
    }
    ...
    public AjaxResult authDataScopeSave(SysRole role) {
        ...
        if (roleService.authDataScope( role ) > 0) {
            ShiroUtils.setSysUser( userService.selectByUserById( ShiroUtils.getSysUser().getUserId() ) );
            return success();
        }
        return error();
    }
