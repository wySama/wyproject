...
public class ExampleEnhancedPlugin  extends PluginAdapter {
    ...
    private void addAndIfMethodToCriteria(TopLevelClass topLevelClass, InnerClass innerClass, IntrospectedTable introspectedTable){
        // 添加接口CriteriaAdd
        org.mybatis.generator.api.dom.java.InnerInterface criteriaAddInterface = new InnerInterface("ICriteriaAdd");
        criteriaAddInterface.setVisibility(JavaVisibility.PUBLIC);
        CommentTools.addInterfaceComment((Interface) criteriaAddInterface, introspectedTable);
        ...
        InnerClass innerClassWrapper = new InnerInterfaceWrapperToInnerClass((cn.com.artlife.codeGenerator.InnerInterface) criteriaAddInterface);
